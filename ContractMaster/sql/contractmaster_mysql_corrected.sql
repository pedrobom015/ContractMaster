...
CREATE TABLE IF NOT EXISTS status_possible( 
    id INT UNSIGNED AUTO_INCREMENT NOT NULL,
    code CHAR(2) NOT NULL,
...
CREATE TABLE IF NOT EXISTS sys_group_program( 
    ...
    CONSTRAINT fk_sys_group_program_group FOREIGN KEY (sys_group_id) REFERENCES sys_group(id),
    CONSTRAINT fk_sys_group_program_program FOREIGN KEY (sys_program_id) REFERENCES sys_program(id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS sys_unit( 
    ...
    CONSTRAINT fk_sys_unit_subsidiary FOREIGN KEY (subsidiary_id) REFERENCES subsidiary(id),
    CONSTRAINT fk_sys_unit_genstat FOREIGN KEY (general_status_id) REFERENCES general_status(id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS sys_user( 
    ...
    CONSTRAINT fk_sys_user_unit FOREIGN KEY (sys_unit_id) REFERENCES sys_unit(id),
    CONSTRAINT fk_sys_user_frontpg FOREIGN KEY (frontpage_id) REFERENCES sys_program(id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS sys_user_group( 
    ...
    CONSTRAINT fk_sys_user_group_user FOREIGN KEY (sys_user_id) REFERENCES sys_user(id),
    CONSTRAINT fk_sys_user_group_group FOREIGN KEY (sys_group_id) REFERENCES sys_group(id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS sys_user_program( 
    ...
    CONSTRAINT fk_sys_user_program_user FOREIGN KEY (sys_user_id) REFERENCES sys_user(id),
    CONSTRAINT fk_sys_user_program_progrm FOREIGN KEY (sys_program_id) REFERENCES sys_program(id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS sys_user_unit( 
    ...
    CONSTRAINT fk_sys_user_unit_user FOREIGN KEY (sys_user_id) REFERENCES sys_user(id),
    CONSTRAINT fk_sys_user_unit_unit FOREIGN KEY (sys_unit_id) REFERENCES sys_unit(id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS address( 
    ...
    CONSTRAINT fk_address_users FOREIGN KEY (sys_user_id) REFERENCES sys_user(id),
    CONSTRAINT fk_address_addtype FOREIGN KEY (address_type_id) REFERENCES address_type(id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS entity_address (
    ...
    CONSTRAINT fk_entity_address_address FOREIGN KEY (address_id) REFERENCES address(id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS document( 
    ...
    CONSTRAINT fk_document_users FOREIGN KEY (sys_user_id) REFERENCES sys_user(id),
    CONSTRAINT fk_document_doctype FOREIGN KEY (document_type_id) REFERENCES document_type(id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS entity_document (
    ...
    CONSTRAINT fk_entity_document_doc FOREIGN KEY (document_id) REFERENCES document(id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS user_company_access (
    ...
    CONSTRAINT fk_user_access_user FOREIGN KEY (sys_user_id) REFERENCES sys_user(id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS entity_sys_user (
    ...
    CONSTRAINT fk_entity_sys_user_user FOREIGN KEY (sys_user_id) REFERENCES sys_user(id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS partner_type (
    ...
    CONSTRAINT fk_partner_type_company FOREIGN KEY (company_id) REFERENCES company(id) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS account_type (
    ...
    CONSTRAINT fk_account_type_company FOREIGN KEY (company_id) REFERENCES company(id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS region (
    ...
    CONSTRAINT fk_region_unit FOREIGN KEY (sys_unit_id) REFERENCES sys_unit(id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS specialty( 
    ...
    CONSTRAINT fk_specialty_unit FOREIGN KEY (sys_unit_id) REFERENCES sys_unit(id),
    CONSTRAINT fk_specialty_users FOREIGN KEY (sys_user_id) REFERENCES sys_user(id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS partner (
    ...
    CONSTRAINT fk_partner_company FOREIGN KEY (company_id) REFERENCES company(id) ON DELETE CASCADE,
    CONSTRAINT fk_partner_unit FOREIGN KEY (sys_unit_id) REFERENCES sys_unit(id),
    CONSTRAINT fk_partner_users FOREIGN KEY (sys_user_id) REFERENCES sys_user(id),
    CONSTRAINT fk_partner_owner FOREIGN KEY (owner_id) REFERENCES sys_user(id),
    CONSTRAINT fk_partner_type FOREIGN KEY (partner_type_id) REFERENCES partner_type(id),
    CONSTRAINT fk_partner_specialty FOREIGN KEY (specialty_id) REFERENCES specialty(id),
    CONSTRAINT fk_partner_billing_addr FOREIGN KEY (billing_address_id) REFERENCES address(id),
    CONSTRAINT fk_partner_shipping_addr FOREIGN KEY (shipping_address_id) REFERENCES address(id),
    CONSTRAINT fk_partner_doc1 FOREIGN KEY (document1_id) REFERENCES document(id),
    CONSTRAINT fk_partner_doc2 FOREIGN KEY (document2_id) REFERENCES document(id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS partner_bank_account (
    ...
    CONSTRAINT fk_partner_bank_partner FOREIGN KEY (partner_id) REFERENCES partner(id) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS classe( 
    ...
    CONSTRAINT fk_class_unit FOREIGN KEY (sys_unit_id) REFERENCES sys_unit(id),
    CONSTRAINT fk_class_users FOREIGN KEY (sys_user_id) REFERENCES sys_user(id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS group_batch( 
    ...
    CONSTRAINT fk_group_batch_unit FOREIGN KEY (sys_unit_id) REFERENCES sys_unit(id),
    CONSTRAINT fk_group_batch_users FOREIGN KEY (sys_user_id) REFERENCES sys_user(id),
    CONSTRAINT fk_group_batch_class FOREIGN KEY (class_id) REFERENCES classe(id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS group_class( 
    ...
    CONSTRAINT fk_group_class_unit FOREIGN KEY (sys_unit_id) REFERENCES sys_unit(id),
    CONSTRAINT fk_group_class_users FOREIGN KEY (sys_user_id) REFERENCES sys_user(id),
    CONSTRAINT fk_group_class_group FOREIGN KEY (group_batch_id) REFERENCES group_batch(id),
    CONSTRAINT fk_group_class_class FOREIGN KEY (class_id) REFERENCES classe(id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS contract( 
    ...
    CONSTRAINT fk_contract_unit FOREIGN KEY (sys_unit_id) REFERENCES sys_unit(id),
    CONSTRAINT fk_contract_users FOREIGN KEY (sys_user_id) REFERENCES sys_user(id),
    CONSTRAINT fk_contract_owner FOREIGN KEY (owner_id) REFERENCES sys_user(id),
    CONSTRAINT fk_contract_partner FOREIGN KEY (partner_id) REFERENCES partner(id),
    CONSTRAINT fk_contract_indicated FOREIGN KEY (indicated_by) REFERENCES sys_user(id),
    CONSTRAINT fk_contract_status FOREIGN KEY (status_id) REFERENCES contract_status(id),
    CONSTRAINT fk_contract_class FOREIGN KEY (class_id) REFERENCES classe(id),
    CONSTRAINT fk_contract_collector FOREIGN KEY (collector_id) REFERENCES sys_user(id),
    CONSTRAINT fk_contract_seller FOREIGN KEY (seller_id) REFERENCES sys_user(id),
    CONSTRAINT fk_contract_region FOREIGN KEY (region_id) REFERENCES region(id),
    CONSTRAINT fk_contract_group FOREIGN KEY (group_batch_id) REFERENCES group_batch(id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci
...
CREATE TABLE IF NOT EXISTS contract_version (
    ...
    CONSTRAINT fk_contract_version_contract FOREIGN KEY (contract_id) REFERENCES contract(id) ON DELETE CASCADE,
    CONSTRAINT fk_contract_version_group FOREIGN KEY (group_batch_id) REFERENCES group_batch(id),
    CONSTRAINT fk_contract_version_created_by FOREIGN KEY (created_by) REFERENCES sys_user(id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci
COMMENT='Versões do contrato - histórico de alterações';

ALTER TABLE contract 
    ADD COLUMN current_version_id INT UNSIGNED AFTER id,
    ADD CONSTRAINT fk_contract_current_version FOREIGN KEY (current_version_id) REFERENCES contract_version(id);
...
CREATE TABLE IF NOT EXISTS contract_covers (
    ...
    start_date TIMESTAMP NOT NULL COMMENT 'Data de início',
    end_date TIMESTAMP NULL COMMENT 'Data de término',
    admission TIMESTAMP NOT NULL COMMENT 'Data de admissão',
    final_grace TIMESTAMP NULL COMMENT 'Carência final',
    grace_period_days VARCHAR(50) COMMENT 'Dias de carência',
    renew_at TIMESTAMP NULL COMMENT 'Data de renovação',
    ...
    CONSTRAINT fk_contract_covers_version FOREIGN KEY (contract_version_id) REFERENCES contract_version(id) ON DELETE CASCADE,
    CONSTRAINT fk_contract_covers_group FOREIGN KEY (group_batch_id) REFERENCES group_batch(id),
    CONSTRAINT fk_contract_covers_class FOREIGN KEY (class_id) REFERENCES classe(id),
    CONSTRAINT fk_contract_covers_status FOREIGN KEY (status_id) REFERENCES general_status(id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci
...
CREATE TABLE IF NOT EXISTS contract_config_billing (
    ...
    CONSTRAINT fk_contract_config_billing_version FOREIGN KEY (contract_version_id) REFERENCES contract_version(id) ON DELETE CASCADE,
    CONSTRAINT fk_contract_config_billing_seller FOREIGN KEY (seller_id) REFERENCES sys_user(id),
    CONSTRAINT fk_contract_config_billing_collector FOREIGN KEY (collector_id) REFERENCES sys_user(id),
    CONSTRAINT fk_contract_config_billing_region FOREIGN KEY (region_id) REFERENCES region(id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci
...
CREATE TABLE IF NOT EXISTS contract_events (
    ...
    CONSTRAINT fk_contract_events_contract FOREIGN KEY (contract_id) REFERENCES contract(id) ON DELETE CASCADE,
    CONSTRAINT fk_contract_events_version FOREIGN KEY (contract_version_id) REFERENCES contract_version(id),
    CONSTRAINT fk_contract_events_created_by FOREIGN KEY (created_by) REFERENCES sys_user(id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci
...
CREATE TABLE IF NOT EXISTS contract_status_history( 
    ...
    INDEX idx_contract_status_history_status (status_possible_id),
    INDEX idx_contract_status_history_reason (status_reason_id),
    CONSTRAINT fk_contract_status_history_statpossib FOREIGN KEY (status_possible_id) REFERENCES status_possible(id),
    CONSTRAINT fk_contract_status_history_statreason FOREIGN KEY (status_reason_id) REFERENCES status_reason(id),
    CONSTRAINT fk_contract_status_history_contract FOREIGN KEY (contract_version_id) REFERENCES contract_version(id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS contract_active( 
    ...
    CONSTRAINT fk_contract_active_unit FOREIGN KEY (sys_unit_id) REFERENCES sys_unit(id),
    CONSTRAINT fk_contract_active_user FOREIGN KEY (sys_user_id) REFERENCES sys_user(id),
    CONSTRAINT fk_contract_number_unique_contract FOREIGN KEY (contract_version_id) REFERENCES contract_version(id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS beneficiary (
    ...
    CONSTRAINT fk_beneficiary_contract FOREIGN KEY (contract_version_id) REFERENCES contract_version(id) ON DELETE RESTRICT ON UPDATE CASCADE,
    CONSTRAINT fk_beneficiary_unit FOREIGN KEY (sys_unit_id) REFERENCES sys_unit(id),
    CONSTRAINT fk_beneficiary_gender FOREIGN KEY (gender_id) REFERENCES gender(id),
    CONSTRAINT fk_beneficiary_document FOREIGN KEY (document_id) REFERENCES document(id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS service_type( 
    ...
    CONSTRAINT fk_service_type_unit FOREIGN KEY (sys_unit_id) REFERENCES sys_unit(id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS performed_service( 
    ...
    CONSTRAINT fk_performed_service_unit FOREIGN KEY (sys_unit_id) REFERENCES sys_unit(id),
    CONSTRAINT fk_performed_service_contract FOREIGN KEY (contract_version_id) REFERENCES contract_version(id),
    CONSTRAINT fk_performed_service_benefic FOREIGN KEY (beneficiary_id) REFERENCES beneficiary(id),
    CONSTRAINT fk_performed_service_servtype FOREIGN KEY (service_type_id) REFERENCES service_type(id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS service_funeral ( 
    ...
    CONSTRAINT fk_service_funeral_version FOREIGN KEY (contract_version_id) REFERENCES contract_version(id),
    CONSTRAINT fk_service_funeral_unit FOREIGN KEY (sys_unit_id) REFERENCES sys_unit(id),
    CONSTRAINT fk_service_funeral_users FOREIGN KEY (sys_user_id) REFERENCES sys_user(id),
    CONSTRAINT fk_service_funeral_perfservic FOREIGN KEY (performed_service_id) REFERENCES performed_service(id),
    CONSTRAINT fk_service_funeral_declarant FOREIGN KEY (declarant_id) REFERENCES sys_user(id),
    CONSTRAINT fk_service_funeral_deceased FOREIGN KEY (deceased_id) REFERENCES beneficiary(id),
    CONSTRAINT fk_service_funeral_officer FOREIGN KEY (office_users_id) REFERENCES sys_user(id),
    CONSTRAINT fk_service_funeral_group FOREIGN KEY (group_batch_id) REFERENCES group_batch(id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci
COMMENT='Funeral services provided to contract beneficiaries';

ALTER TABLE beneficiary 
    ADD CONSTRAINT fk_beneficiary_funservice FOREIGN KEY (service_funeral_id) REFERENCES service_funeral(id);
...
CREATE TABLE IF NOT EXISTS death_event (
    ...
    CONSTRAINT fk_death_event_group FOREIGN KEY (group_batch_id) REFERENCES group_batch(id),
    CONSTRAINT fk_death_event_beneficiary FOREIGN KEY (beneficiary_id) REFERENCES beneficiary(id),
    CONSTRAINT fk_death_event_service FOREIGN KEY (service_funeral_id) REFERENCES service_funeral(id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS carteirinha( 
    ...
    updated_by INT UNSIGNED,
    PRIMARY KEY (id),
    INDEX idx_carteirinha_performed (performed_service_id),
    INDEX idx_carteirinha_unit (sys_unit_id),
    INDEX idx_carteirinha_user (sys_user_id),
    INDEX idx_carteirinha_version (contract_version_id),
    INDEX idx_carteirinha_beneficiary (beneficiary_id),
    CONSTRAINT fk_carteirinha_service FOREIGN KEY (performed_service_id) REFERENCES performed_service(id),
    CONSTRAINT fk_carteirinha_unit FOREIGN KEY (sys_unit_id) REFERENCES sys_unit(id),
    CONSTRAINT fk_carteirinha_user FOREIGN KEY (sys_user_id) REFERENCES sys_user(id),
    CONSTRAINT fk_carteirinha_version FOREIGN KEY (contract_version_id) REFERENCES contract_version(id),
    CONSTRAINT fk_carteirinha_beneficiary FOREIGN KEY (beneficiary_id) REFERENCES beneficiary(id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS equipament_rental( 
    ...
    CONSTRAINT fk_equipament_rental_perfservic FOREIGN KEY (performed_service_id) REFERENCES performed_service(id),
    CONSTRAINT fk_equipament_rental_unit FOREIGN KEY (sys_unit_id) REFERENCES sys_unit(id),
    CONSTRAINT fk_equipament_rental_user FOREIGN KEY (sys_user_id) REFERENCES sys_user(id),
    CONSTRAINT fk_equipament_rental_version FOREIGN KEY (contract_version_id) REFERENCES contract_version(id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS addendum( 
    ...
    CONSTRAINT fk_addendum_unit FOREIGN KEY (sys_unit_id) REFERENCES sys_unit(id),
    CONSTRAINT fk_addendum_gstat FOREIGN KEY (general_status_id) REFERENCES general_status(id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS age_addendum( 
    ...
    CONSTRAINT fk_age_addendum_unit FOREIGN KEY (sys_unit_id) REFERENCES sys_unit(id),
    CONSTRAINT fk_age_addendum_user FOREIGN KEY (sys_user_id) REFERENCES sys_user(id),
    CONSTRAINT fk_age_addendum_addendum FOREIGN KEY (addendum_id) REFERENCES addendum(id),
    CONSTRAINT fk_age_addendum_class FOREIGN KEY (class_id) REFERENCES classe(id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS contract_addendum( 
    ...
    CONSTRAINT fk_contract_addendum_unit FOREIGN KEY (sys_unit_id) REFERENCES sys_unit(id),
    CONSTRAINT fk_contract_addendum_contract FOREIGN KEY (contract_version_id) REFERENCES contract_version(id),
    CONSTRAINT fk_contract_addendum_addendum FOREIGN KEY (addendum_id) REFERENCES addendum(id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS contract_charge (
    ...
    CONSTRAINT fk_contract_charge_contract FOREIGN KEY (contract_version_id) REFERENCES contract_version(id) ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT fk_contract_charge_unit FOREIGN KEY (sys_unit_id) REFERENCES sys_unit(id),
    CONSTRAINT fk_contract_charge_payment FOREIGN KEY (payment_status_id) REFERENCES payment_status(id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS charge( 
    ...
    CONSTRAINT fk_charge_unit FOREIGN KEY (sys_unit_id) REFERENCES sys_unit(id),
    CONSTRAINT fk_charge_users FOREIGN KEY (sys_user_id) REFERENCES sys_user(id),
    CONSTRAINT fk_charge_group FOREIGN KEY (group_batch_id) REFERENCES group_batch(id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS prorated_service(
    ...
    CONSTRAINT fk_prorated_service_id_charge FOREIGN KEY (charge_id) REFERENCES charge(id),
    CONSTRAINT fk_prorated_service_id_servfuner FOREIGN KEY (service_funeral_id) REFERENCES service_funeral(id),
    CONSTRAINT fk_prorated_service_id_unit FOREIGN KEY (sys_unit_id) REFERENCES sys_unit(id),
    CONSTRAINT fk_prorated_service_id_user FOREIGN KEY (sys_user_id) REFERENCES sys_user(id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS bank_slip( 
    ...
    CONSTRAINT fk_bank_slip_unit FOREIGN KEY (sys_unit_id) REFERENCES sys_unit(id),
    CONSTRAINT fk_bank_slip_users FOREIGN KEY (sys_user_id) REFERENCES sys_user(id),
    CONSTRAINT fk_bank_slip_charge FOREIGN KEY (contract_charge_id) REFERENCES contract_charge(id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS ordpgrc( 
    ...
    CONSTRAINT fk_ordpgrc_unit FOREIGN KEY (sys_unit_id) REFERENCES sys_unit(id),
    CONSTRAINT fk_ordpgrc_users FOREIGN KEY (sys_user_id) REFERENCES sys_user(id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS payment_receipt( 
    ...
    CONSTRAINT fk_payment_receipt_subsidiary FOREIGN KEY (subsidiary_id) REFERENCES subsidiary(id),
    CONSTRAINT fk_payment_receipt_unit FOREIGN KEY (sys_unit_id) REFERENCES sys_unit(id),
    CONSTRAINT fk_payment_receipt_users FOREIGN KEY (sys_user_id) REFERENCES sys_user(id),
    CONSTRAINT fk_payment_receipt_contract FOREIGN KEY (contract_version_id) REFERENCES contract_version(id),
    CONSTRAINT fk_payment_receipt_ordpgrc FOREIGN KEY (ordpgrc_id) REFERENCES ordpgrc(id),
    CONSTRAINT fk_payment_receipt_paystat FOREIGN KEY (payment_status_id) REFERENCES payment_status(id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS batch_chk( 
    ...
    CONSTRAINT fk_batch_chk_subsidiary FOREIGN KEY (subsidiary_id) REFERENCES subsidiary(id),
    CONSTRAINT fk_batch_chk_unit FOREIGN KEY (sys_unit_id) REFERENCES sys_unit(id),
    CONSTRAINT fk_batch_chk_users FOREIGN KEY (sys_user_id) REFERENCES sys_user(id),
    CONSTRAINT fk_batch_chk_ordpgrc FOREIGN KEY (ordpgrc_id) REFERENCES ordpgrc(id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS batch_detail( 
    ...
    CONSTRAINT fk_batch_detail_batch FOREIGN KEY (batch_chk_id) REFERENCES batch_chk(id),
    CONSTRAINT fk_batch_detail_contcharge FOREIGN KEY (contract_charge_id) REFERENCES contract_charge(id),
    CONSTRAINT fk_batch_detail_paymstat FOREIGN KEY (payment_status_id) REFERENCES payment_status(id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS billing_cycle (
    ...
    CONSTRAINT fk_billing_cycle_group FOREIGN KEY (group_batch_id) REFERENCES group_batch(id),
    CONSTRAINT fk_billing_cycle_unit FOREIGN KEY (sys_unit_id) REFERENCES sys_unit(id),
    CONSTRAINT fk_billing_cycle_user FOREIGN KEY (sys_user_id) REFERENCES sys_user(id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS contract_billing (
    ...
    CONSTRAINT fk_contract_billing_cycle FOREIGN KEY (cycle_id) REFERENCES billing_cycle(id),
    CONSTRAINT fk_contract_billing_version FOREIGN KEY (contract_version_id) REFERENCES contract_version(id),
    CONSTRAINT fk_contract_billing_unit FOREIGN KEY (sys_unit_id) REFERENCES sys_unit(id),
    CONSTRAINT fk_contract_billing_user FOREIGN KEY (sys_user_id) REFERENCES sys_user(id),
    CONSTRAINT fk_contract_billing_charge FOREIGN KEY (charge_id) REFERENCES contract_charge(id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS payment_plan (
    ...
    CONSTRAINT fk_payment_plan_version FOREIGN KEY (contract_version_id) REFERENCES contract_version(id),
    CONSTRAINT fk_payment_plan_unit FOREIGN KEY (sys_unit_id) REFERENCES sys_unit(id),
    CONSTRAINT fk_payment_plan_user FOREIGN KEY (sys_user_id) REFERENCES sys_user(id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS payment_plan_installment (
    ...
    CONSTRAINT fk_installment_plan FOREIGN KEY (plan_id) REFERENCES payment_plan(id),
    CONSTRAINT fk_installment_unit FOREIGN KEY (sys_unit_id) REFERENCES sys_unit(id),
    CONSTRAINT fk_installment_user FOREIGN KEY (sys_user_id) REFERENCES sys_user(id),
    CONSTRAINT fk_installment_charge FOREIGN KEY (charge_id) REFERENCES contract_charge(id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS payment_transaction (
    ...
    CONSTRAINT fk_transaction_version FOREIGN KEY (contract_version_id) REFERENCES contract_version(id),
    CONSTRAINT fk_transaction_unit FOREIGN KEY (sys_unit_id) REFERENCES sys_unit(id),
    CONSTRAINT fk_transaction_user FOREIGN KEY (sys_user_id) REFERENCES sys_user(id),
    CONSTRAINT fk_transaction_charge FOREIGN KEY (charge_id) REFERENCES contract_charge(id),
    CONSTRAINT fk_transaction_installment FOREIGN KEY (installment_id) REFERENCES payment_plan_installment(id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS billing_rule (
    ...
    CONSTRAINT fk_billing_rule_unit FOREIGN KEY (sys_unit_id) REFERENCES sys_unit(id),
    CONSTRAINT fk_billing_rule_user FOREIGN KEY (sys_user_id) REFERENCES sys_user(id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS billing_rule_application (
    ...
    CONSTRAINT fk_billing_rule_app_rule FOREIGN KEY (rule_id) REFERENCES billing_rule(id),
    CONSTRAINT fk_billing_rule_app_unit FOREIGN KEY (sys_unit_id) REFERENCES sys_unit(id),
    CONSTRAINT fk_billing_rule_app_user FOREIGN KEY (sys_user_id) REFERENCES sys_user(id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS medical_foward( 
    ...
    CONSTRAINT fk_medical_foward_unit FOREIGN KEY (sys_unit_id) REFERENCES sys_unit(id),
    CONSTRAINT fk_medical_foward_users FOREIGN KEY (sys_user_id) REFERENCES sys_user(id),
    CONSTRAINT fk_medical_foward_accredit FOREIGN KEY (partner_id) REFERENCES partner(id),
    CONSTRAINT fk_medical_foward_perfservic FOREIGN KEY (performed_service_id) REFERENCES performed_service(id),
    CONSTRAINT fk_medical_foward_ordpgrc FOREIGN KEY (ordpgrc_id) REFERENCES ordpgrc(id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS cep_cache( 
    ...
    INDEX idx_cep_cache_cidade (cidade_id),
    INDEX idx_cep_cache_estado (estado_id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO document_type (id, description) VALUES 
(1, 'CPF'),
(2, 'RG'),
(3, 'CNH')
...
INSERT INTO subsidiary (id, name, code, status) VALUES 
(1, 'Matriz', 'BPL', '1'),
(2, 'Poços', 'POC', '1')
ON DUPLICATE KEY UPDATE name = VALUES(name);

INSERT INTO sys_group (id, name, uuid) VALUES 
(1, 'Admin', NULL),
(2, 'Standard', NULL)
ON DUPLICATE KEY UPDATE name = VALUES(name);
