...
import ClasseManager from "@/components/contracts/tables/classe-manager";
              ...
              <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
                <div className="space-y-4">
                  <TabsList className="grid w-full grid-cols-5">
                    ...
                    <TabsTrigger value="groups" className="neu-flat">Grupos</TabsTrigger>
                  ...
                  <div className="neu-flat rounded-2xl p-6">
                    <div className="flex items-center justify-between mb-6">
                      <div>
                        ...
                        <p className="text-muted-foreground mt-2">Gerencie os grupos</p>
                      </div>
                    </div>
                  </div>
                  {renderGroupsTab()}
