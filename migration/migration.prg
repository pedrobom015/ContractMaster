...
zap
appe from cobrador
repl id with 100+recno() all
use cob2migr alias cobrador
...
IF .F.
 ...
 sql_classes() // classe
 inkey(61)
 sql_arqgrup() // group_batch
 inkey(61)
 sql_grupos()  // contract
 inkey(61)
 sql_document() // document (from contract) 
 inkey(61)
 sql_entity_doc() //  related - contract and document
 inkey(61)
 sql_benefic() // inscrits
 inkey(61)
 sql_contract_charge() // taxas 
 inkey(61)
ENDIF
sql_cobrador() // partner (collector) 
...
? "INSERT INTO `sys_unit` (`sys_unit_id`, `subsidiary_id`, `general_status_id`, `name`, `connection_name`, `code`) VALUES ('1', '1', '1', 'Presserv Limeira', NULL, 'LIM');"
...
? "INSERT INTO `sys_user` (`sys_user_id`, `name`, `login`, `password_salt`, `email`, `active`) VALUES (2, 'System Presserv User', 'system', '', 'suporte@presserv.com.br', 'Y');"
...
? "INSERT INTO `payment_status` (`payment_status_id`, `name`, `code`, `kanban`, `color`, `kanban_order`, `final_state`, `initial_state`, `allow_edition`, `allow_deletion`, `created_at`, `updated_at`, `deleted_at`, `created_by`, `updated_by`, `deleted_by`) VALUES ('10', 'Gerada', '01', '1', NULL, NULL, NULL, NULL, NULL, NULL, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL, NULL, NULL, NULL);"
? "INSERT INTO `payment_status` (`payment_status_id`, `name`, `code`, `kanban`, `color`, `kanban_order`, `final_state`, `initial_state`, `allow_edition`, `allow_deletion`, `created_at`, `updated_at`, `deleted_at`, `created_by`, `updated_by`, `deleted_by`) VALUES ('20', 'Impressa', '02', '2', NULL, NULL, NULL, NULL, NULL, NULL, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL, NULL, NULL, NULL);"
? "INSERT INTO `payment_status` (`payment_status_id`, `name`, `code`, `kanban`, `color`, `kanban_order`, `final_state`, `initial_state`, `allow_edition`, `allow_deletion`, `created_at`, `updated_at`, `deleted_at`, `created_by`, `updated_by`, `deleted_by`) VALUES ('30', 'Enviada', '03', '3', NULL, NULL, NULL, NULL, NULL, NULL, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL, NULL, NULL, NULL);"
? "INSERT INTO `payment_status` (`payment_status_id`, `name`, `code`, `kanban`, `color`, `kanban_order`, `final_state`, `initial_state`, `allow_edition`, `allow_deletion`, `created_at`, `updated_at`, `deleted_at`, `created_by`, `updated_by`, `deleted_by`) VALUES ('40', 'Rejeitada', '04', '4', NULL, NULL, NULL, NULL, NULL, NULL, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL, NULL, NULL, NULL);"
? "INSERT INTO `payment_status` (`payment_status_id`, `name`, `code`, `kanban`, `color`, `kanban_order`, `final_state`, `initial_state`, `allow_edition`, `allow_deletion`, `created_at`, `updated_at`, `deleted_at`, `created_by`, `updated_by`, `deleted_by`) VALUES ('50', 'Aceita', '05', '5', NULL, NULL, NULL, NULL, NULL, NULL, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL, NULL, NULL, NULL);"
? "INSERT INTO `payment_status` (`payment_status_id`, `name`, `code`, `kanban`, `color`, `kanban_order`, `final_state`, `initial_state`, `allow_edition`, `allow_deletion`, `created_at`, `updated_at`, `deleted_at`, `created_by`, `updated_by`, `deleted_by`) VALUES ('60', 'Paga na recepção', '06', '6', NULL, NULL, NULL, NULL, NULL, NULL, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL, NULL, NULL, NULL);"
? "INSERT INTO `payment_status` (`payment_status_id`, `name`, `code`, `kanban`, `color`, `kanban_order`, `final_state`, `initial_state`, `allow_edition`, `allow_deletion`, `created_at`, `updated_at`, `deleted_at`, `created_by`, `updated_by`, `deleted_by`) VALUES ('70', 'Paga em Banco', '07', '6', NULL, NULL, NULL, NULL, NULL, NULL, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL, NULL, NULL, NULL);"
? "INSERT INTO `payment_status` (`payment_status_id`, `name`, `code`, `kanban`, `color`, `kanban_order`, `final_state`, `initial_state`, `allow_edition`, `allow_deletion`, `created_at`, `updated_at`, `deleted_at`, `created_by`, `updated_by`, `deleted_by`) VALUES ('80', 'Baixada na Cobranca', '08', '8', NULL, NULL, NULL, NULL, NULL, NULL, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL, NULL, NULL, NULL);"
? "INSERT INTO `payment_status` (`payment_status_id`, `name`, `code`, `kanban`, `color`, `kanban_order`, `final_state`, `initial_state`, `allow_edition`, `allow_deletion`, `created_at`, `updated_at`, `deleted_at`, `created_by`, `updated_by`, `deleted_by`) VALUES ('90', 'Baixada na Adm', '099', '9', NULL, NULL, NULL, NULL, NULL, NULL, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL, NULL, NULL, NULL);"
...
? " VALUES ('1', '2', '1', '1', '13485392','Rua Apparecida Bosqueiro Boldrin', '221' ,'Jd Porto Real II', NULL, 'Limeira', 'SP', 'BR','OBS', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL, NULL, NULL, NULL);"
...
IF !EMPT(endereco)
 ...
 ? "INSERT INTO `address` (`address_id`, `sys_user_id`, `address_type_id`, `is_main`, `zip_code`, `address`, `address_number`, `address_line1`, `address_line2`, `city`, `state`, `country`, `observacao`, `created_at`, `updated_at`, `deleted_at`, `created_by`, `updated_by`, `deleted_by`) " 
 ? " VALUES ('"+alltrim(str(id))+"', '2', '1', '1', '13480000','"+ alltrim(ENDERECO)+"', '"+SUBSTR(endereco,RAT([,],ENDERECO)+1)+"' ,'"+alltrim( BAIRRO)+"', NULL, '"+alltrim(CIDADE)+"', NULL, 'BR','OBS', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL, NULL, NULL, NULL);"
 ? "SET @address_id = LAST_INSERT_ID();"
 newpartner:=.T.
ENDIF
IF !EMPT(cpf)
 ...
 ? "INSERT INTO `document` (`document_id`, `sys_user_id`, `document_type_id`, `document_number`, `filename`, `file_path`, `file_size`, `mime_type`, `created_at`, `updated_at`, `deleted_at`, `created_by`, `updated_by`, `deleted_by`) "
 ? " VALUES ('"+alltrim(str(id))+"', '2', '1',"+ cpf+", '', '', NULL, NULL, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL, NULL, NULL, NULL);"
 ? "SET @document_id = LAST_INSERT_ID();"
 newpartner:=.T.
ENDIF
IF (newpartner) .or. (pontovirgula)
 ? "INSERT INTO `partner` (`partner_id`, `company_id`, `sys_unit_id`, `sys_user_id`, `partner_code`, `partner_name`, `legal_name`, `tax_id`, `partner_type_id`, `is_customer`, `is_vendor`, `is_collector`, `is_employee`, `is_accredited`, `specialty_id`, `advantages`, `observation`, `credit_limit`, `payment_terms`, `billing_address_id`, `shipping_address_id`, `doccument1_id`, `doccument2_id`, `phone`, `email`, `website`, `primary_partner_person`, `notes`, `receivable_account_id`, `payable_account_id`, `currency`, `tax_code_id`, `active`, `created_at`, `updated_at`, `deleted_at`, `created_by`, `updated_by`, `deleted_by`) "
 ? " VALUES ("
 pontovirgula:=newpartner:=.F.
ELSE 
 ?? ", "
 ? "("
ENDIF
 ?? "'"+alltrim(str(id))+"', '1', '1', '2', '"
 ?? alltrim(cobrador)+"', '"
 ?? alltrim(Nome)+"', '"
 ?? alltrim(nome)+"', NULL, '1', '0', '0', '1', '0', '0', '1', 'vantagens', 'observacao', '0', NULL,"
 IF !EMPT(endereco)
  ?? "'"+alltrim(str(id))+"', '"+alltrim(str(id))+"', "
 ELSE 
  ?? "NULL,NULL,"
 ENDIF
 IF !EMPT(cpf)
...
IF !EMPT(endereco)
 ...
 pontovirgula=.T.
 ? "INSERT INTO `entity_address` (`entity_type`, `entity_id`, `address_id`, `is_primary`) "
 ?? " VALUES ('partner', '"+alltrim(str(id))+"', '"+alltrim(str(id))+"', '1');"
 newpartner:=.T.
ENDIF
IF !EMPT(cpf) 
 IF EMPT(endereco)
