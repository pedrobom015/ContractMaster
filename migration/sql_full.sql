...
INSERT INTO sys_user (sys_user_id, name, login, password_salt, email, active) VALUES (0, 'System Automation', 'system', '', 'system@presserv.com.br', 'Y');
--
...
BEGIN
    ...
    -- Get charge details
    SELECT contract_id, amount, charge_code 
    INTO v_contract_id, v_total_amount, v_charge_code
    FROM contract_charge
    WHERE contract_charge_id = p_charge_id;
