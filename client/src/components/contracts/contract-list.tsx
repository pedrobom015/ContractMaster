        ...
        {contracts?.map((contract) => (
          ...
          >
            <div className="flex justify-between items-start mb-3">
              ...
              <div className={cn("rounded-xl px-3 py-1", contract.statusId ? getStatusColor(contract.statusId) : "bg-gray-100")}>
                <span className="text-xs font-medium">{contract.statusId ? getStatusLabel(contract.statusId) : "N/A"}</span>
              </div>
            </div>
