...
import { Plus, Edit, Trash2, Search, Link2, Network } from "lucide-react";
...
export default function EntityAddressesPage() {
  const { t } = useLanguage();
            ...
            <div className="flex items-center justify-between mb-6">
              <div>
                ...
                <p className="text-muted-foreground text-lg">
                  Gerencie os vínculos entre entidades e endereços
                </p>
              </div>
              <Badge variant="outline" className="neu-flat text-lg px-4 py-2">
                {filteredEntityAddresses.length} vínculos
              </Badge>
            </div>
          </div>
            ...
            <CardHeader>
              <CardTitle className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  ...
                  Lista de Vínculos Entidade-Endereço
                </div>
                <Badge variant="outline" className="neu-flat">
                  {filteredEntityAddresses.length} encontrados
                </Badge>
              </CardTitle>
            </CardHeader>
            <CardContent>
